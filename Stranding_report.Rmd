...
What length of average section?  
Does characterizing the entire cross section tell us enough about the area between the high and low water lines, which is really all that matters in this case? 

## Potential extensions
There are lots of potential ties to geomorphic theory, can link to hydraulic geometry etc  
Validation/verification with real stranding data  
Comparisons to other systems in BC (with stranding data)  
Do the completed channel enhancements downstream of show up in this sort of a measure?  
FREEBIRD or other optical bathymetric mappping as a means of getting depths (kind of an inverse DEM) and applying this sort of approach. 
